...
class MetadataStore(rpyc.Service):
	...
	def exposed_store_location(self, hash, block_no):
		self.HashLoc.update({hash:block_no})

	def exposed_get_location(self, hash):
		return self.HashLoc[hash]
